    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        assert (
                ...
                or (
                    ...
                    and 0 <= index <= len(self.indexed_dataset()) - 1
                )
        )
        ...
        for i in range(current_index, next_index):
            data_page.append(dataset.get(i))

        next_condition = next_index if next_index < len(dataset) else None

        return {
                "index": current_index,
                "next_index": next_condition,
                "page_size": page_size,
                "data": data_page
        }
